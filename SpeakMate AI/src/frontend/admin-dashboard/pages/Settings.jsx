 ...
 *
 * Professional SaaS Settings page with a two-column tabbed layout.
 */
                ...
                <div className="lg:col-span-8 xl:col-span-9">
                    ...
                    >
                        ...
                        {activeTab === "appearance" && (
                            <SectionCard
                                title="Appearance"
                                subtitle="Customize how the super admin dashboard looks"
                            >
                                <Toggle
                                    icon={Moon}
                                    label="Dark Mode"
                                    description="Use a darker theme across the super admin dashboard"
                        ...
                        {activeTab === "backup" && (
                            <SectionCard
                                ...
                                subtitle="Manage platform backups and data recovery"
                            >
                        ...
                        {activeTab === "help" && (
                            <SectionCard
                                title="Help & Support"
                                subtitle="Get assistance or view documentation"
                            >
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-surface)] p-4 max-w-xl">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="mt-0.5 text-xs text-[var(--text-secondary)]">
                                                 Need help or have questions about super admin panel?
                                            </p>
                                        </div>
                                    </div>
