...
/**
 * admin-dashboard/components/SectionCard.jsx
 *
 * Shared panel wrapper used across the redesigned Super Admin Dashboard.
 * Provides a consistent header (title + subtitle + optional action),
 * a body slot, and subtle entrance animation.
 *
 * Props:
 *   title, subtitle, action (ReactNode), className, bodyClassName,
 *   delay (animation), children
 */
