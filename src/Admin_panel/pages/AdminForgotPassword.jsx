...
export function AdminForgotPassword() {
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-50 px-4 py-12 sm:px-6">
      {/* Same decorative background as AdminLogin — kept identical for
          visual continuity across the admin auth flow. */}
      ...
      >
        ...
        <AdminCard className="mt-6 p-7 sm:p-9">
          ...
          <p className="mt-2 text-sm text-slate-600">
            Enter your admin email address and we&apos;ll send you a one-time password (OTP) to verify
            your identity.
          </p>
